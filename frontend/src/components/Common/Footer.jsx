      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 px-4 lg:px-0">
        ...
        <div>
          ...
          <form className="flex">
            <input
              ...
              required
              className="p-3 w-full text-sm border border-gray-300 
        ...
        <nav aria-label="Shop">
          ...
          <ul className="space-y-2 text-gray-600">
            <li><Link to="#" className="hover:text-black transition-colors">Men&apos;s Top Wear</Link></li>
            <li><Link to="#" className="hover:text-black transition-colors">Women&apos;s Top Wear</Link></li>
            <li><Link to="#" className="hover:text-black transition-colors">Men&apos;s Bottom Wear</Link></li>
            <li><Link to="#" className="hover:text-black transition-colors">Women&apos;s Bottom Wear</Link></li>
          </ul>
        </nav>
        ...
        <div>
          ...
          <div className="flex items-center space-x-5 mb-6">
            <a
              ...
              className="hover:text-gray-600 hover:scale-110 transition-transform cursor-pointer"
            >
